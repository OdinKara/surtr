 ...
 *
 * The primary is read from the first ACCEPTED entry of the first page, which
 * matters: accepted means the three-part gate passed, so the author is us and
 * the count is ours rather than some other participant's.
 */
